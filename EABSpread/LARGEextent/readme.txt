...
The only difference here between the small and large files are lines 5-8 of the first file, which define the source and dimensions of the area being simulated. Otherwise the rest of the files work and process data the same, just with a much larger input ASCII file for input.
